return {
  ...
  config = function()
      ...
      lua_ls = {
        ...
        settings = {
          Lua = {
            ...
            format = { enable = false }, -- Because we use stylua to format the code
    ...
    -- The following handler function is the callback that gets called whenever Lsp starts for a buffer
